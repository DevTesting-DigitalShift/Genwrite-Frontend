        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <Card className="bg-primary/5 border-primary/20 shadow-none col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-semibold text-primary/90">AEO Target</h3>
            </div>
          ...
          <Card className="bg-white border-gray-100 shadow-sm col-span-1 md:col-span-1">
            <div className="flex flex-col justify-between h-full">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 font-bold mt-2">LLM Answer Presence</p>
              </div>
            </div>
          </Card>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left">
                  <thead className="bg-[#FAFBFD] text-gray-400 font-semibold text-[11px]">
                    <tr>
                      <th className="px-8 py-5">AEO Rank</th>
                      <th className="px-8 py-5">Answer AI Relevance</th>
                      <th className="px-8 py-5 text-center">Share of Answer</th>
                      <th className="px-8 py-5 text-right pr-12">Confidence Index</th>
                    </tr>
                  </thead>
                      ...
                      <tr key={idx} className="hover:bg-gray-50/30 transition-colors group">
                        ...
                        <td className="px-8 py-5 text-right pr-12">
                          <span className="text-xs font-semibold text-gray-400">
                            {comp.ranks?.length || 0} AEO Captures
                          </span>
                        </td>
                      </tr>
                    ))}
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full text-sm text-left">
          <thead className="text-[11px] bg-[#FAFBFD] text-gray-400 font-semibold border-b border-gray-50">
            <tr>
              <th className="px-8 py-5">AEO Discovery Token</th>
              <th className="px-8 py-5">AI Answer Rank</th>
              <th className="px-8 py-5">Top Answer Engines</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-50">
            {results.map((r, i) => (
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-none p-4 sm:p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">AEO Website Ranker</h1>
                <p className="text-sm text-gray-500 mt-0.5">
                  Analyze Answer Engine Optimization (AEO), AI visibility, and LLM signals.
                </p>
              </div>
            </div>
            <button
                  ...
                  <div className="flex justify-between items-center mb-6 px-2">
                    <Steps
                      ...
                      items={[
                        ...
                        { title: "AEO Tokens", icon: <Zap className="w-5 h-5" /> },
                        { title: "Check Presence", icon: <BarChart2 className="w-5 h-5" /> },
                        { title: "View Roadmap", icon: <FileText className="w-5 h-5" /> },
                      ]}
                    />
                  </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        <h3 className="text-lg font-bold flex items-center gap-2">
                          <Zap className="text-amber-500" /> Step 2: Extract AEO Tokens
                        </h3>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl">
                        <p className="text-xs font-medium text-gray-400 mb-4">
                          Edit Your AEO Discovery Tokens
                        </p>
