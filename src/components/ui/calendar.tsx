...
function Calendar({
  ...
  /** Button variant used for the day cells and nav arrows. */
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-3 rounded-2xl sm:w-[300px] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
